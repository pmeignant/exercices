...
public class Sort {
    ...
    public static void main (String[] args) {
        ...
        final List<Integer> result1 = mergeSort(dataTest1);
        ...
        System.out.println("List 1 { " +
                ...
                "}");
        final List<Integer> result2 = mergeSort(dataTest2);
        ...
        final List<Integer> result3 = mergeSort(dataTest3);
        ...
        final List<Integer> result4 = mergeSort(dataTest4);
